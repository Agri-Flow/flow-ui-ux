...
function Sidebar({ active = 'dashboard', setActive }) {
  return (
    <aside style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '18px 20px' }}>
        <div style={{
          ...
          <img src="../../assets/logo/leaf-rotated-white.png" alt="" style={{ height: '100%', objectFit: 'contain', width: "25px" }} />
        </div>
      ...
      <div style={{ borderTop: '1px solid #F0F0F0', padding: '14px 16px', display: 'flex', gap: 10, alignItems: 'center' }}>
        <div style={{ width: 34, height: 34, borderRadius: '50%', background: '#1B8C4E', color: '#fff', fontWeight: 700, fontSize: 13, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>SJ</div>
        <div style={{ flex: 1 }}>
