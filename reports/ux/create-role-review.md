# Design Review — create-role

**Reviewed file:** `ui-flow/agriflow-rwanda-design-system/project/screens/create-role.html`
...
- [P2] P2-1: Inline SVG count is 21 (> 20). Icon system would deduplicate.
- [P2] P2-2: File is 657 lines (> 500). Consider splitting state previews into sibling files.
