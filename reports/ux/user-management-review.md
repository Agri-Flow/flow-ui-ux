# Design Review — user-management

**Reviewed file:** `ui-flow/agriflow-rwanda-design-system/project/screens/user-management.html`
...
- [P2] P2-1: Inline SVG count is 81 (> 20). Icon system would deduplicate.
- [P2] P2-2: File is 1052 lines (> 500). Consider splitting state previews into sibling files.
